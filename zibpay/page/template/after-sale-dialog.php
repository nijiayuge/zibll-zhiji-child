...
<el-dialog
    ...
    title="<?php echo esc_attr__('售后处理', 'zib_language'); ?>"
    ...
    <el-form class="order-edit-form" :model="after_sale_data.handle_dialog_data" label-position="top">
        ...
        <div class="text-box mb20">
            ...
            <div class="flex ac jsb mt6 pointer" @click="shippingDetails(after_sale_data.handle_dialog_data)">
                ...
                <div class="flex ac">
                    <el-tag :type="['warning', 'primary', 'success'][after_sale_data.handle_dialog_data.shipping_status] || 'warning'">{{ shipping_status_name[after_sale_data.handle_dialog_data.shipping_status] || '<?php echo esc_js(__('未知', 'zib_language')); ?>' }}</el-tag>
                    <div class="badg c-purple" v-if="after_sale_data.handle_dialog_data.shipping_status == '1'" ><count-down :end-time="after_sale_data.handle_dialog_data.shipping_receipt_over_time"></count-down><?php echo esc_html__('后自动收货', 'zib_language'); ?></div>
                    <div class="flex ac"><i class="dashicons dashicons-arrow-right-alt2 opacity5 em09 ml3"></i></div>
                </div>
            </div>
        </div>
        ...
        <el-timeline>
            <el-timeline-item :timestamp="after_sale_data.handle_dialog_data.after_sale_data.user_apply_time" placement="top">
                <div>
                    <div class="flex ac">
                        <b><?php echo esc_html__('用户发起售后申请', 'zib_language'); ?></b>
                        <div class="badg ml10" :class="after_sale_data.type_color[after_sale_data.handle_dialog_data.after_sale_type] || 'c-yellow'">{{after_sale_type_name[after_sale_data.handle_dialog_data.after_sale_type] || '<?php echo esc_js(__('未知', 'zib_language')); ?>'}}</div>
                    </div>
                    <div class="flex ac mt6" v-if="after_sale_data.handle_dialog_data.after_sale_data.reason">
                        <div class="opacity5 mr10 flex0"><?php echo esc_html__('售后原因：', 'zib_language'); ?></div>
                    ...
                    <div class="flex ac mt6" v-if="after_sale_data.handle_dialog_data.after_sale_data.price || ['refund', 'insured_price'].includes(after_sale_data.handle_dialog_data.after_sale_type)">
                        <div class="opacity5 mr10 flex0"><?php echo esc_html__('退款金额：', 'zib_language'); ?></div>
                    ...
                    <div class="flex ac mt6" v-if="after_sale_data.handle_dialog_data.after_sale_data.remark">
                        <div class="opacity5 mr10 flex0"><?php echo esc_html__('申请备注：', 'zib_language'); ?></div>
                        <div class="c-yellow">{{after_sale_data.handle_dialog_data.after_sale_data.remark}}</div>
                    </div>
                </div>
            </el-timeline-item>
            <el-timeline-item timestamp="<?php echo esc_js(__('等待商家同意或拒绝', 'zib_language')); ?>" placement="top" v-if="after_sale_data.handle_dialog_data.after_sale_status == 1" color="#0bbd87">
                <el-form-item>
                ...
                <template v-if="after_sale_data.handle_dialog_data.pay_modo == 'points'">
                    <el-form-item label="<?php echo esc_attr__('退款到用户', 'zib_language'); ?>" v-if="after_sale_data.handle_dialog_data.handle_type == 'agree'">
                        <div><?php echo esc_html__('积分账户', 'zib_language'); ?></div>
                    </el-form-item>
                </template>
                ...
                <template v-else-if="['refund', 'insured_price'].includes(after_sale_data.handle_dialog_data.after_sale_type)">
                    <template v-if="after_sale_data.handle_dialog_data.handle_type == 'agree'">
                        <!-- 选择退款渠道 -->
                        <el-form-item label="<?php echo esc_attr__('退款到用户', 'zib_language'); ?>">
                            <div class="c-yellow px12" style="flex-basis:100%;" v-if="after_sale_data.handle_dialog_data.pay_type == 'balance'"><?php echo esc_html__('用户使用余额付款，建议退款到余额', 'zib_language'); ?></div>
                        ...
                        <el-form-item label="<?php echo esc_attr__('用户收款码', 'zib_language'); ?>" v-if="after_sale_data.handle_dialog_data.refund_channel == 'wechat' || after_sale_data.handle_dialog_data.refund_channel == 'alipay'">
                            <div class="text-center mr10">
                                ...
                                <div class="text-center"><?php echo esc_html__('微信收款码', 'zib_language'); ?></div>
                            </div>
                            <div class="text-center">
                                ...
                                <div class="text-center"><?php echo esc_html__('支付宝收款码', 'zib_language'); ?></div>
                            </div>
                        </el-form-item>
                    </template>
                </template>
                ...
                <template v-if="['refund_return', 'replacement','warranty'].includes(after_sale_data.handle_dialog_data.after_sale_type)">
                    <el-form-item label="<?php echo esc_attr__('商家收货地址', 'zib_language'); ?>" v-if="after_sale_data.handle_dialog_data.handle_type == 'agree'">
                        ...
                        <div @click="afterSaleReturnAddressDialog" style="cursor: pointer;width: 1100%;">
                                ...
                                <div class="text-box flex ac">
                                    <div class="address-content flex1">
                                        <div class="address-detail muted-color flex ac">
                                            <div class="name-phone mb6"><span class="name">{{after_sale_data.handle_dialog_data.return_address.name}}</span><span class="phone ml10">{{after_sale_data.handle_dialog_data.return_address.phone}}</span><span class="badg badg-sm c-blue"><?php echo esc_html__('家', 'zib_language'); ?></span></div>
                                        </div>
                            ...
                            <div v-else>
                                <div class="but c-yellow"><?php echo esc_html__('选择退回地址', 'zib_language'); ?></div>
                            </div>
                        </div>
                ...
                <el-form-item label="<?php echo esc_attr__('备注信息', 'zib_language'); ?>">
                    <el-input type="textarea" v-model="after_sale_data.handle_dialog_data.author_remark" placeholder="<?php echo esc_attr__('请填写处理留言', 'zib_language'); ?>" :rows="3"></el-input>
                    <div class="c-yellow" v-if="after_sale_data.handle_dialog_data.handle_type == 'refuse' && !after_sale_data.handle_dialog_data.author_remark"><?php echo esc_html__('请填写拒绝原因等信息', 'zib_language'); ?></div>
                </el-form-item>
                <el-form-item>
                    <el-button type="primary" :loading="loading.handle_dialog_submit_but" :disabled="!after_sale_data.handle_dialog_data.handle_type" @click="afterSaleHandleSubmit"><?php echo esc_html__('确认提交', 'zib_language'); ?></el-button>
                </el-form-item>
            </el-timeline-item>
            ...
            <el-timeline-item :timestamp="after_sale_data.handle_dialog_data.after_sale_data.author_handle_time" placement="top" v-if="after_sale_data.handle_dialog_data.after_sale_status == 2 && after_sale_data.handle_dialog_data.after_sale_data.author_handle_time">
                <div class="flex ac">
                    <b><?php echo esc_html__('商家已同意', 'zib_language'); ?></b>
                </div>
                <div class="flex mt6" v-if="after_sale_data.handle_dialog_data.after_sale_data.return_address">
                    <div class="opacity5 mr10 flex0"><?php echo esc_html__('退货地址：', 'zib_language'); ?></div>
                    <div>
                ...
                <div class="flex ac mt6" v-if="after_sale_data.handle_dialog_data.after_sale_data.author_remark">
                    <div class="opacity5 mr10 flex0"><?php echo esc_html__('处理备注：', 'zib_language'); ?></div>
            ...
            <el-timeline-item :timestamp="after_sale_data.handle_dialog_data.after_sale_data.user_return_time" placement="top" v-if="after_sale_data.handle_dialog_data.after_sale_status == 2 && after_sale_data.handle_dialog_data.after_sale_data.user_return_time">
                <div class="flex ac">
                    <b><?php echo esc_html__('用户已发货', 'zib_language'); ?></b>
                ...
                <div class="flex ac mt6">
                    <div class="opacity5 mr10 flex0"><?php echo esc_html__('快递单号：', 'zib_language'); ?></div>
                    <div class="flex ac">
                        <div>{{after_sale_data.handle_dialog_data.after_sale_data.user_return_data.express_number}}</div>
                        <el-button class="ml10" size="small" @click="afterSaleExpressDialog(after_sale_data.handle_dialog_data, 'user_return')"><?php echo esc_html__('查看物流信息', 'zib_language'); ?></el-button>
                    </div>
                </div>
                <div class="flex ac mt6" v-if="after_sale_data.handle_dialog_data.after_sale_data.user_return_data.return_remark">
                    <div class="opacity5 mr10 flex0"><?php echo esc_html__('发货备注：', 'zib_language'); ?></div>
                    <div class="c-yellow">{{after_sale_data.handle_dialog_data.after_sale_data.user_return_data.return_remark}}</div>
                </div>
            </el-timeline-item>

            <el-timeline-item timestamp="<?php echo esc_js(__('等待商家退款', 'zib_language')); ?>" placement="top" v-if="after_sale_data.handle_dialog_data.after_sale_status == 2 && after_sale_data.handle_dialog_data.after_sale_data.progress == 2" color="#0bbd87">
                <!-- 退货退款商家处理 -->
                <template v-if="after_sale_data.handle_dialog_data.after_sale_type === 'refund_return'">

                    <div class="c-yellow mb10"><?php echo esc_html__('请确认收到退货后，再处理退款，如遇到货物问题，请与客户沟通', 'zib_language'); ?></div>
                    ...
                    <el-form-item>
                        <el-button type="primary" :loading="loading.handle_dialog_submit_but" @click="afterSalerefundReturnSubmit"><?php echo esc_html__('确认退货退款', 'zib_language'); ?></el-button>
                    </el-form-item>
...
<!-- 售后详情抽屉 -->
<el-drawer
    title="<?php echo esc_attr__('售后详情', 'zib_language'); ?>"
    ...
    <div class="drawer-content" v-if="after_sale_data.details_drawer_data">
        <div class="card-box mb20">
            ...
            <div class="flex ac jsb mt6 pointer" @click="shippingDetails(after_sale_data.details_drawer_data)">
                <div class="opacity5 mr10 flex0"><?php echo esc_html__('发货状态：', 'zib_language'); ?></div>
                <div class="flex ac">
                    <el-tag :type="['warning', 'primary', 'success'][after_sale_data.details_drawer_data.shipping_status] || 'warning'">{{ shipping_status_name[after_sale_data.details_drawer_data.shipping_status] || '<?php echo esc_js(__('未知', 'zib_language')); ?>' }}</el-tag>
                    <div class="badg c-purple" v-if="after_sale_data.details_drawer_data.shipping_status == '1'" ><count-down :end-time="after_sale_data.details_drawer_data.shipping_receipt_over_time"></count-down><?php echo esc_html__('后自动收货', 'zib_language'); ?></div>
                    <div class="flex ac"><i class="dashicons dashicons-arrow-right-alt2 opacity5 em09 ml3"></i></div>
                </div>
            </div>
        </div>
        <div class="" v-if="[1,2,'1','2'].includes(after_sale_data.details_drawer_data.after_sale_status)">
            <div class="box-title mb10"><?php echo esc_html__('当前售后进度', 'zib_language'); ?></div>
            <el-timeline>
                <el-timeline-item :timestamp="after_sale_data.details_drawer_data.after_sale_data.user_apply_time" placement="top">
                    <div>
                        <div class="flex ac">
                            <b><?php echo esc_html__('用户发起售后申请', 'zib_language'); ?></b>
                            <div class="badg ml10" :class="after_sale_data.type_color[after_sale_data.details_drawer_data.after_sale_type] || 'c-yellow'">{{after_sale_type_name[after_sale_data.details_drawer_data.after_sale_type] || '<?php echo esc_js(__('未知', 'zib_language')); ?>'}}</div>
                        </div>
                ...
                <el-timeline-item timestamp="<?php echo esc_js(__('等待商家同意或拒绝', 'zib_language')); ?>" placement="top" v-if="after_sale_data.details_drawer_data.after_sale_status == 1" color="#0bbd87">
                </el-timeline-item>
                ...
                <el-timeline-item :timestamp="after_sale_data.details_drawer_data.after_sale_data.user_return_time" placement="top" v-if="after_sale_data.details_drawer_data.after_sale_status == 2 && after_sale_data.details_drawer_data.after_sale_data.user_return_time">
                    ...
                    <div class="flex ac mt6">
                        ...
                        <div class="flex ac">
                            ...
                            <el-button class="ml10" size="small" @click="afterSaleExpressDialog(after_sale_data.details_drawer_data,'user_return')"><?php echo esc_html__('查看物流信息', 'zib_language'); ?></el-button>
                        </div>
                    </div>
                ...
                <el-timeline-item timestamp="<?php echo esc_js(__('最新进度', 'zib_language')); ?>" placement="top">
                    <el-button type="primary" plain @click="afterSaleHandle(after_sale_data.details_drawer_data)" v-if="after_sale_data.details_drawer_data.after_sale_status == 1"><?php echo esc_html__('立即处理', 'zib_language'); ?></el-button>
                    <div class="c-yellow em09 mt6" v-if="after_sale_data.details_drawer_data.after_sale_status == 1"><?php echo esc_html__('待商家审核', 'zib_language'); ?></div>
                    <el-tag v-if="after_sale_data.details_drawer_data.after_sale_status > 2" :type="[ 'warning','warning','success','success','danger','danger'][after_sale_data.details_drawer_data.after_sale_status] || 'warning'">
                        {{ after_sale_data.status_name[after_sale_data.details_drawer_data.after_sale_status] || '<?php echo esc_js(__('未知', 'zib_language')); ?>' }}
                    </el-tag>
                    <el-button type="primary" @click="afterSaleHandle(after_sale_data.details_drawer_data)" v-if="after_sale_data.details_drawer_data.after_sale_status == 2 && after_sale_data.details_drawer_data.after_sale_data.progress == 2"><?php echo esc_html__('立即处理', 'zib_language'); ?></el-button>
                    <div v-if="after_sale_data.details_drawer_data.after_sale_status == 2" class="em09" :class="[ 'c-yellow','c-yellow','c-yellow','c-green','c-red','c-red'][after_sale_data.details_drawer_data.after_sale_data.progress] || 'c-yellow'">
                        {{ after_sale_data.progress_name[after_sale_data.details_drawer_data.after_sale_data.progress] || '<?php echo esc_js(__('未知', 'zib_language')); ?>' }}
                    </div>
                    <div class="badg c-yellow em09" v-if="after_sale_data.details_drawer_data.after_sale_status == 2 && after_sale_data.details_drawer_data.after_sale_data.progress == 1"><count-down :end-time="after_sale_data.details_drawer_data.after_sale_return_express_over_time"></count-down><?php echo esc_html__('后未发货自动取消', 'zib_language'); ?></div>
                </el-timeline-item>
            </el-timeline>
        </div>

        <div class="box-title mb10"><?php echo esc_html__('历史售后记录', 'zib_language'); ?></div>
        <div v-loading="loading.after_sale_record_html">
            ...
            <div class="text-center" v-else>
                <el-empty description="<?php echo esc_attr__('暂无售后记录', 'zib_language'); ?>" />
            </div>
        </div>
    </div>
...
<!-- 选择退回地址 -->
<el-dialog
    title="<?php echo esc_attr__('选择退回地址', 'zib_language'); ?>"
    ...
    <div class="return-address-dialog-content">
        ...
        <div v-if="after_sale_data.return_address_dialog_data.length" class="address-list">
            <div class="text-box mb10 pointer" v-for="(item, index) in after_sale_data.return_address_dialog_data" :key="'address-' + index" @click="afterSaleSelectAddress(item)">
                ...
                <div class="address-actions flex ac jsb">
                    <span class="default-badge badg badg-sm c-red" v-if="item.is_default"><?php echo esc_html__('默认', 'zib_language'); ?></span>
                    <button class="el-button el-button--small" v-else @click.prevent.stop="setDefaultAddress(item)" :item-id="item.id"><?php echo esc_html__('设为默认', 'zib_language'); ?></button>
                    <div class="action-btns px12">
                        <button class="el-button el-button--small" @click.prevent.stop="editAddress(item)"><?php echo esc_html__('编辑', 'zib_language'); ?></button>
                        <button class="el-button el-button--small c-red ml6" @click.prevent.stop="deleteAddress(item.id)" v-if="!item.is_default"><?php echo esc_html__('删除', 'zib_language'); ?></button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div v-else class="text-center">
            <el-empty description="<?php echo esc_attr__('暂无收货地址', 'zib_language'); ?>" />
        </div>

        <!-- 底部操作按钮 -->
        <div class="dialog-footer mt20 flex jc">
            <el-button type="primary" @click="afterSaleAddNewAddress" class="mr10"><?php echo esc_html__('添加新地址', 'zib_language'); ?></el-button>
        </div>
    ...
    <!-- 添加新地址弹窗 -->
    <el-dialog
        :title="author_data.new_address_dialog_data.id ? '<?php echo esc_js(__('编辑地址', 'zib_language')); ?>' : '<?php echo esc_js(__('添加新地址', 'zib_language')); ?>'"
        ...
        <div class="add-new-address-dialog-content">
            ...
            <el-form :model="author_data.new_address_dialog_data" label-width="120px">
                <el-form-item label="<?php echo esc_attr__('收货人', 'zib_language'); ?>">
                    <el-input v-model="author_data.new_address_dialog_data.name" placeholder="<?php echo esc_attr__('请输入收货人', 'zib_language'); ?>"></el-input>
                </el-form-item>
                <el-form-item label="<?php echo esc_attr__('联系电话', 'zib_language'); ?>">
                    <el-input v-model="author_data.new_address_dialog_data.phone" placeholder="<?php echo esc_attr__('请输入联系电话', 'zib_language'); ?>"></el-input>
                </el-form-item>
                <el-form-item label="<?php echo esc_attr__('省份', 'zib_language'); ?>">
                    <el-input v-model="author_data.new_address_dialog_data.province" placeholder="<?php echo esc_attr__('请输入省份', 'zib_language'); ?>"></el-input>
                </el-form-item>
                <el-form-item label="<?php echo esc_attr__('城市', 'zib_language'); ?>">
                    <el-input v-model="author_data.new_address_dialog_data.city" placeholder="<?php echo esc_attr__('请输入城市', 'zib_language'); ?>"></el-input>
                </el-form-item>
                <el-form-item label="<?php echo esc_attr__('区县', 'zib_language'); ?>">
                    <el-input v-model="author_data.new_address_dialog_data.county" placeholder="<?php echo esc_attr__('请输入区县', 'zib_language'); ?>"></el-input>
                </el-form-item>
                <el-form-item label="<?php echo esc_attr__('详细地址', 'zib_language'); ?>">
                    <el-input v-model="author_data.new_address_dialog_data.address" placeholder="<?php echo esc_attr__('请输入详细地址', 'zib_language'); ?>"></el-input>
                </el-form-item>
                <el-form-item label="<?php echo esc_attr__('标签', 'zib_language'); ?>">
                    <el-input v-model="author_data.new_address_dialog_data.tag" placeholder="<?php echo esc_attr__('请输入地址标签', 'zib_language'); ?>"></el-input>
                </el-form-item>
                <el-form-item label="<?php echo esc_attr__('设为默认', 'zib_language'); ?>">
                    <el-switch v-model="author_data.new_address_dialog_data.is_default"></el-switch>
                </el-form-item>
                <el-form-item>
                    <el-button type="primary" :loading="loading.author_address_submit_but" @click="AuthorAddressSubmit"><?php echo esc_html__('确认提交', 'zib_language'); ?></el-button>
                </el-form-item>
            </el-form>
        </div>
    </el-dialog>
